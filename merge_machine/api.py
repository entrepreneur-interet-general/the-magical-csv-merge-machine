...
@cross_origin()
def sample(project_type, project_id):
    '''
    Generate a sample.
    ...
    POST:
        - sampler_module_name: (ex: 'sample_mvs'). TODO: explicit
        - module_params: parameters generated by the associated inference module 
                          (ex: result of infer_mvs)
        - sample_params: parameters to use for sampling TODO: standardize and explicit
    ...
    module_params = all_params.get('module_params', None)
    sample_params = all_params.get('sample_params', None)
